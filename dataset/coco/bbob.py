...
class BBOB_Dataset(Dataset):
    ...
    def get_datasets(suit,
        ...
        if difficulty=='easy':
            # train_pro_id=func_id-small_set_func_id
            train_pro_id=list(set(func_id)-set(small_set_func_id))
            test_pro_id=small_set_func_id
        elif difficulty=='difficult':
            train_pro_id=small_set_func_id
            test_pro_id=list(set(func_id)-set(small_set_func_id))
        ...
        return BBOB_Dataset(train_set, train_batch_size), np.array(train_pro_id), BBOB_Dataset(test_set, test_batch_size),np.array(test_pro_id)
